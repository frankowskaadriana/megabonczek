...
public class Strzyga : MonoBehaviour
{
    [Header("Statystyki")]
    ...
    void Start()
    {
        ...
        if (mesh != null)
        {
            ...
            mesh.material.color = new Color(0.5f, 0.2f, 0.1f);
        }
    ...
    void IgnoreEnemyCollisions()
    {
        ...
        // Znajdü wszystkich wrogÛw po tagu
        ...
        // Znajdü teø po komponencie EnemyHealth
